...
// This is the inner layout component, which uses useLocation safely
function AppLayout({
  setLoginStatus,
  setUserType,
  oid,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-3">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <NavLink to="/information" icon={Info}>
                Information
              </NavLink>
...
// This is the actual Home component that wraps everything inside Router
function Home(props) {
  return (
    <Router>
      <AppLayout {...props} />
